...
window.PAVILLON_SESSIONS = [
  {
    ...
    "resumeCourt": "À quelques jours du départ du Saint-Michel pour la Guadeloupe, Solenn Brissac, Baron Bayard, Anduin Marlow et Aldry Baratte sont chargés de retrouver Dorak Maugemeur, le pilote du navire, disparu depuis la veille. Leur recherche les mène de tavernes en cachots, puis au cœur d'une bagarre générale pour récupérer un mystérieux carnet de navigation.",
    "resumeDetaille": [
      ...
      "Le groupe réunit Solenn Brissac, chirurgienne originaire de Brest ; Baron Bayard, jeune noble envoyé dans la marine ; Anduin Marlow, Nantais rêvant de devenir canonnier ; et Aldry Baratte, marin ayant déjà une expérience en mer et spécialisé comme gabier. Ils se connaissent encore peu lorsque le quartier-maître du Saint-Michel leur confie leur première tâche commune : Dorak Maugemeur, le pilote du navire, est introuvable, alors que le capitaine attend son retour à bord.",
      ...
      "Dorak révèle alors que ses ennuis ne se limitent pas à une mauvaise soirée. La veille, il aurait remporté aux cartes une importante somme d’argent, mais surtout un ancien carnet de navigation. Son adversaire, Thomas Novabrux, un autre pilote, l’aurait accusé de tricher. Plus tard dans la nuit, Dorak aurait été attaqué par plusieurs hommes et dépouillé de son argent, de ses armes et du précieux carnet. Pour lui, ce dernier compte bien davantage que l’argent perdu.",
      ...
      "Ils rencontrent également le capitaine Dany le Pinguy, ancien premier lieutenant de la Marine royale, qui a participé financièrement à l’armement du navire. Son expérience militaire laisse présager une discipline particulièrement rigoureuse à bord.",
  ...
  },
  {
    ...
    "resumeDetaille": [
      ...
      "Dans l’entrepont bondé, un craquement anormal annonce une catastrophe : l’un des canons s’est détaché. Sous l’effet de la houle, la pièce d’artillerie extrêmement lourde traverse l’entrepont en roulant et fauche plusieurs marins. Anduin, Aldry et Baron réagissent immédiatement. Les hommes sont écartés de sa trajectoire, des cordages sont utilisés pour reprendre le contrôle de la pièce et, après plusieurs minutes d’efforts dans le chaos, le canon finit par être sécurisé.",
      ...
      "Le capitaine Dany le Pinguy réagit avec une colère extrême. Pour lui, certaines pertes sont dues à des négligences, notamment le canon mal sécurisé et plusieurs problèmes dans la préparation du navire. Il décide donc de désigner quatre responsables : paff59, julienofjardin, okkyn et berl_uue. Chacun est condamné à huit coups de fouet.",
      "Baron tente d’intervenir auprès du capitaine, lui demandant de ne pas aller trop loin et estimant que la sanction symbolique pourrait suffire. Dany le Pinguy refuse sèchement et lui fait comprendre qu’il a lui-même échappé de peu à une punition pour avoir osé discuter l’ordre. Les quatre marins sont fouettés. paff59 et berl_uue survivent, mais julienofjardin et okkyn meurent de leurs blessures. Leurs corps, comme ceux des autres morts, sont ensuite confiés à la mer selon les usages du bord.",
      "Les jours suivants deviennent particulièrement difficiles. Une distribution générale de rhum proposée pour remonter le moral de l’équipage est refusée par le capitaine. Surtout, le Saint-Michel découvre qu’il a perdu son escorte pendant la tempête. Personne ne sait avec certitude ce qu’il est advenu des autres bâtiments. Plus inquiétant encore, Dorak peine momentanément à déterminer précisément leur position après les intempéries. Baron l’apprend, tandis qu’Aldry surprend également cette information au cours de ses leçons avec le pilote. Ils savent néanmoins que le navire continue vers l’ouest et devrait finir par retrouver sa route.",
      "Pendant cette période, Anduin commence à tenir discrètement un journal. Il souhaite conserver une trace de ce qui se produit pendant la traversée et continuer à pratiquer la lecture et l’écriture. Baron profite de cette habitude pour lui demander d’écouter ce qui se dit parmi les matelots et de lui rapporter leur état d’esprit, puisqu’un officier comme lui n’obtient pas toujours les mêmes confidences.",
      ...
      "Solenn, de son côté, se montre plutôt attentive aux marins qu’elle soigne. Elle utilise notamment discrètement une partie de ses réserves de rhum pour améliorer certaines préparations destinées aux hommes épuisés ou blessés. Baron adopte lui aussi une attitude conciliante lorsqu’il le peut, préférant fermer les yeux sur certaines petites infractions plutôt que d’envoyer systématiquement les matelots devant le capitaine.",
      "Cette tension finit pourtant par prendre une tournure beaucoup plus grave.",
      "Un matin, Solenn et Baron sont conduits discrètement jusqu’au corps de Blackangele, le cuisinier du navire, retrouvé mort dans un recoin du bâtiment. L’examen de Solenn montre qu’il a été poignardé quelques heures auparavant avec un gros couteau du type de ceux que possèdent de très nombreux marins. La blessure, située vers la hanche et l’aine, semble avoir été portée par derrière.",
      "Baron décide d’enquêter et fait appel à Anduin et Aldry. En discutant avec les matelots, ils découvrent que Blackangele était loin de faire l’unanimité : il distribuait clandestinement des portions supplémentaires de nourriture à certains marins en échange de faveurs, créant jalousies et ressentiment dans un équipage où les ressources commencent justement à manquer.",
      "Après plusieurs heures à recouper les informations, ils finissent par identifier le meurtrier : Darlingsamaa.",
      "Le groupe se retrouve alors face à un choix délicat. Le dénoncer au capitaine entraînerait presque certainement sa pendaison, mais dénoncer ouvertement un matelot risquerait également de leur aliéner une partie de l’équipage, déjà particulièrement méfiante à l’égard des officiers. Ils décident finalement de ne pas livrer Darlingsamaa à Dany le Pinguy. Baron le confronte lui-même, l’épée à portée, lui fait comprendre qu’il connaît la vérité et lui rappelle qu’un seul mot de sa part suffirait à le condamner. Il lui ordonne de ne plus provoquer de nouvel incident et lui signifie qu’il lui doit désormais la vie. L’intimidation semble fonctionner.",
      "Le calme ne revient pourtant pas immédiatement.",
      "Peu avant l’arrivée prévue aux Antilles, une nouvelle dispute éclate parmi les matelots après des jeux d’argent interdits à bord. Trois hommes ayant perdu une importante somme se battent. Cette fois, Dany le Pinguy choisit une sanction encore plus brutale : vingt-cinq coups de fouet chacun. Les trois marins meurent des suites de la punition. L’exemple produit l’effet recherché : les derniers jours deviennent nettement plus silencieux, même si personne à bord ne peut vraiment parler d’une atmosphère apaisée.",
      ...
      "Alors que le capitaine fait réduire la toile par précaution, la vigie annonce une autre présence : une frégate sous pavillon anglais. La France et l’Angleterre ne sont pourtant pas officiellement en guerre. Le bâtiment semble d’abord vouloir dépasser le Saint-Michel, avant de modifier sa route pour se rapprocher dangereusement. Dany le Pinguy ordonne immédiatement le branle-bas de combat.",
      "Les sabords s’ouvrent et les deux bâtiments se préparent à tirer.",
      "L’échange est brutal. Une salve de mitraille anglaise balaie le pont du Saint-Michel, frappant plusieurs membres de l’équipage. Aldry, grâce à ses réflexes, parvient non seulement à se mettre à l’abri mais aussi à tirer plusieurs marins hors de la trajectoire. Baron esquive également le tir, tandis que Solenn rejoint immédiatement son infirmerie pour se préparer à accueillir les blessés.",
      ...
      "Avant de prendre davantage de distance, Baron propose toutefois d’utiliser les pièces de fuite du Saint-Michel. Anduin prend place au canon et tire un boulet chaîné vers la mâture anglaise. Le coup atteint sa cible et endommage le mât, sans parvenir à l’abattre complètement. La frégate reste donc capable de naviguer et demeure derrière eux.",
    ...
    "evenements": [
      ...
      "paff59, julienofjardin, okkyn et berl_uue sont condamnés au fouet",
      "julienofjardin et okkyn meurent de leurs blessures",
      "L’escorte du Saint-Michel a disparu et le navire s’est écarté de sa route",
      "La tension augmente entre marins et officiers",
      "Blackangele est retrouvé assassiné",
      "L’enquête identifie Darlingsamaa comme le meurtrier",
      "Baron décide de ne pas le dénoncer au capitaine et l’intimide",
    ...
    "coulisses": [
      ...
      "Le public a également choisi la mort du cuisinier Blackangele. L’autre possibilité aurait provoqué l’apparition de malades et la crainte d’une épidémie à bord.",
  ...
  },
  {
    ...
    "resumeDetaille": [
      ...
      "Certains hommes tentent de rejoindre la côte à la nage tandis qu’une unique chaloupe est mise à l’eau. Dans le chaos, Baron Bayard tente de structurer l’évacuation, aidé notamment par Tenqneoo, le second du navire, tandis que Dorak participe également à l’organisation. Baron parvient à faire mettre la chaloupe à l’eau et à canaliser une partie des hommes.",
      "Le bilan est catastrophique : sur l’ensemble de l’équipage du Saint-Michel, seuls environ 25 survivants atteignent finalement la côte. Dany le Pinguy ne fait pas partie d’eux et demeure porté disparu. Le sort de plusieurs autres membres de l’équipage, notamment Chad et Accra, reste inconnu.",
      ...
      "À la tombée de la nuit, Tenqneoo organise des tours de garde tandis que Baron prend la responsabilité d’un autre groupe. Tenqneoo reste officiellement le supérieur hiérarchique des survivants en tant que second du Saint-Michel. Cependant, l’attitude de Baron depuis le naufrage lui a gagné la confiance d’une partie des matelots, qui semblent désormais plus enclins à l’écouter.",
    ...
    "evenements": [
      ...
      "Dany le Pinguy est porté disparu",
      ...
      "Baron devient un chef officieux aux yeux d’une partie des matelots",
      ...
      "Une volée de flèches frappe le groupe et Baron est blessé au bras gauche",
    ...
    "coulisses": [
      "Le public a choisi Baron plutôt que Tenqneoo lors d’un sondage lié au commandement. Tenqneoo reste le responsable officiel en tant que second du Saint-Michel, mais Baron devient le chef officieux préféré d’une partie des matelots.",
