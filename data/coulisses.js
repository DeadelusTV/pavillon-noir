// ONGLET COULISSES
// Votes du public, principes et illustrations.

window.PAVILLON_COULISSES = {
  "principes": [
    {
  ...
  "votes": [
    ...
    {
      "session": "Session 02",
      "question": "Quel accident doit frapper le Saint-Michel pendant la tempête ?",
      "gagnant": "Un canon se décroche dans l’entrepont",
      "autre": "Une partie du mât s’effondre",
      "consequence": "Le canon devient un danger immédiat pour les hommes à bord ; l’autre possibilité aurait davantage menacé le navire lui-même."
    },
    {
      "session": "Session 02",
