...
window.PAVILLON_LORE = [
  ...
  {
    "id": "passage-tropique-cancer",
    "categorie": "Vie maritime",
    "titre": "Passage du tropique du Cancer",
    "sousTitre": "Rite de passage des marins",
    "resume": "Un baptême maritime marque le premier franchissement du tropique du Cancer.",
    "details": [
      "Les marins qui ne l’ont jamais franchi doivent l’admettre devant le quartier-maître, déguisé en juge pour l’occasion.",
      "Ils reçoivent ensuite plusieurs seaux d’eau de mer sur la tête en guise de baptême."
    ]
  },
  {
    "id": "discipline-saint-michel",
    "categorie": "Vie maritime",
    ...
    "details": [
      ...
      "Les relations entre officiers et matelots deviennent progressivement délétères."
    ]
  },
  {
    "id": "fregate-anglaise",
    "categorie": "Navires",
    "titre": "La frégate anglaise",
    "sousTitre": "Navire sous pavillon anglais · Session 02",
    "resume": "Une frégate sous pavillon anglais attaque le Saint-Michel alors que la France et l’Angleterre ne sont pas officiellement en guerre.",
    "details": [
